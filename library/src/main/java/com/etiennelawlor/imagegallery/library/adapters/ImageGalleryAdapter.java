...
//        Log.e("gallery","imageGallery: " + image+ " holder.imageView: "+holder.imageView + " gridItemWidth: " +gridItemWidth);
        Log.e("gallery" ,  "imageThumbnailLoader:000 " +imageThumbnailLoader);
    ...
    public void setImageThumbnailLoader(ImageThumbnailLoader loader) {
        ...
        Log.e("gallery" ,  "imageThumbnailLoader:11 " +imageThumbnailLoader);
    }
