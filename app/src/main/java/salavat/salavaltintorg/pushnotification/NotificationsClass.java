...
import salavat.salavaltintorg.NotificationPageActivity;
import salavat.salavaltintorg.R;
...
public class NotificationsClass {
    ...
    void NotificationShow(Context context , String title , String desc ,String header , String body , String footer){
        ...
        Intent intent = new Intent(context, NotificationPageActivity.class);
