...
class GroupAdaptor extends RecyclerView.Adapter<GroupAdaptor.holder> {
    List<Notification> notifications;
    public GroupAdaptor(GroupListActivity notificationActivity, List<Notification> notifications) {
