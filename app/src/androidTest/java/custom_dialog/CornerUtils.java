...
public class CornerUtils {
     ...
     * (ListViewçš„itemç‚¹å‡»æ•ˆæžœ,å�ªå¤„ç�†æœ€å�Žä¸€é¡¹åœ†è§’å¤„ç�†)
     */
     ...
     * (ListViewçš„itemç‚¹å‡»æ•ˆæžœ,ç¬¬ä¸€é¡¹å’Œæœ€å�Žä¸€é¡¹åœ†è§’å¤„ç�†)
     */
    public static StateListDrawable listItemSelector(float radius, int normalColor, int pressColor, int itemTotalSize,
        ...
        if (itemPosition == 0 && itemPosition == itemTotalSize - 1) {// å�ªæœ‰ä¸€é¡¹
